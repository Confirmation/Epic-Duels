/**
 * To be run in conjunction with TestClient
 */
...
public class TestServer extends JFrame {
	...
	public TestServer() {
		...
		setLocation(100, 100);
		setLayout(null);
		setTitle("Test Networking (Server Side)");
...
class ClientPanel extends JPanel implements Observer {
